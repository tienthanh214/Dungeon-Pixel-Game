...
public class Character extends Entity {
    ...
    static {
        ...
        LoadImageData.loadImageData(imageData, "file:Game\\StrategyDemo\\assets\\image\\lizard_m");
    }
    ...
    public Character(int offset, double posX, double posY) {
        this(null, offset, posX, posY);

    }

    public Character(Camera camera, int offset, double posX, double posY) {
        super(10, 1);
