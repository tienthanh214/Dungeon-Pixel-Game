...
public class RedDemon extends Entity {
    ...
    static {
        ...
        LoadImageData.loadImageData(imageData, "file:Game\\StrategyDemo\\assets\\image\\big_demon");
    }
    ...
    public RedDemon(int offset) {
        this(offset, imageData[0].getWidth(), imageData[0].getHeight());
    }

    public RedDemon(int offset, double posX, double posY) {
        this(null, offset, posX, posY);

    }

    public RedDemon(Camera camera, int offset, double posX, double posY) {
        super(10, 1);
        this.imageView = new ImageView();
        this.weapon = new NullWeapon();
        imageView.setImage(imageData[offset * columns]);
        this.animation = new SpriteAnimation(this, imageData, Duration.millis(6000 / GamePlay.FPS), 
